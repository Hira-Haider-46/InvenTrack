...
const CreateStock = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Created new stock:", formData);
    navigate("/");
  };
    ...
    <div className="px-8 py-10">
      ...
      <form onSubmit={handleSubmit} className="px-2 md:px-8 my-5">
        ...
        <div className="flex justify-between items-center">
          <button
            type="submit"
            className=" bg-[#1E88E5] border border-[#1E88E5] text-white px-8 py-2 rounded hover:text-[#1E88E5] hover:bg-white cursor-pointer"
          >
            Add Stock
          </button>
          <button
